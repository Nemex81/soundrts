...
- [UI-MASTER-03/C1-HITTEST] `soundrts/clientgamehud.py`: API pubblica `HudPanel.rect_for(name)` e `HudPanel.panel_names()` per accesso read-only ai rect dei pannelli HUD. Disaccoppia i consumer esterni dall'attributo privato `_panel_rects`.
